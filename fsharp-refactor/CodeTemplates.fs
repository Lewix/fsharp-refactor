...
type FunctionCall =
    ...
    static member ParameterRange = mkRange "/home/lewis/test.fs" (mkPos 1 14) (mkPos 1 24)
...
type FunctionDefinition =
    ...
    static member ParameterRange = mkRange "/home/lewis/test.fs" (mkPos 1 17) (mkPos 1 27)
