...
testRename()
{
    ...
    result=$(mono CommandLine.exe rename 1:13 c testfiles/functioncode.fs 2>&1)
...
testExtractFunction()
{
    ...
    result=$(mono CommandLine.exe extract-function 1:0 1:3 g testfiles/functioncode.fs 2>&1)
    ...
    result=$(mono CommandLine.exe extract-function 2:1 2:4 f testfiles/expressioncode.fs 2>&1)
